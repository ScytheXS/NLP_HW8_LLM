...
shorty = Character(
    name="Shorty",
    languages=["English"],
    persona="I prefer to give short and precise responses.",
    conversational_style="short and concise",
    conversation_starters=["Do you think veganism is sustainable?", "What about animal welfare?"]
)
